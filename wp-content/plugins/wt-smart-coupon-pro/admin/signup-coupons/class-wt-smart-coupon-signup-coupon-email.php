...
if( ! class_exists ( 'WT_smart_Coupon_Signup_Coupon_Email' ) ) {
	class WT_smart_Coupon_Signup_Coupon_Email extends WC_Email{
		...
		function __construct() {
			...
			$this->heading        = __( 'You have received a Signup Coupon', 'wt-smart-coupons-for-woocommerce-pro' );
			...
			$this->template_base = WT_SMARTCOUPON_MAIN_PATH . 'admin/signup-coupons/';
